...
public class Log {
	...
	/**
	 * Constructor establishes a log file based on the current time in the
	 * canonical directory
	 * 
	 * @throws IOException
	 *             if log file or BufferedWriter cannot be created
	 */
	 ...
	 *            CarPark being used
	 * @param sim
	 *            Simulator providing parameters
	 * @throws IOException
	 *             on write failures
	 */
	 ...
	 * 
	 * @param time
	 *            int holding current simulation time step
	 * @param cp
	 *            CarPark being used
	 * @throws IOException
	 *             on write failures
